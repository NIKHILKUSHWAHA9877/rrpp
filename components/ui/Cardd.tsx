...
const Cardd: React.FC = () => {
  return (
    <section className="">
      <div className=" px-8 md:px-12 mx-auto py-12 lg:py-24 space-y-24 h-svh flex flex-col justify-center">
        <div className="flex flex-col sm:flex-row mx-auto">
          <a href="#_">
            <img
              ...
              className="rounded-xl rotate-6 hover:rotate-0 duration-500 hover:-translate-y-12  object-cover w-[200px] sm:w-[150px] md:w-[200px] lg:w-60 xl:w-[300px]  hover:scale-150 transform origin-bottom"
              alt="#_"
            />
          </a>
          <a href="#_">
            <img
              ...
              className="rounded-xl -rotate-12 hover:rotate-0 duration-500 hover:-translate-y-12  object-cover w-[200px] sm:w-[150px] md:w-[200px] lg:w-60 xl:w-[300px]  hover:scale-150 transform origin-bottom"
              alt="#_"
            />
          </a>
          <a href="#_">
