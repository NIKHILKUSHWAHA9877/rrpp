...
export const workTiles: WorkTile[] = [
  ...
  {
    description: 'Ohhh yeahhh, baby! 💥 Our Googenix editors turned up the heat on Ikko Mikke with some next-level cuts & transitions! 🎥✨ With 250M+ views and profits stacking up like a viral TikTok trend 💰📈, this hit proves that when we edit, we don’t just cut—we create magic! Watch now and see why the big leagues trust us to bring the boom to their visuals! 🎶🚀🔥',
    title:
    (
      <>
    <span className="underlined underline-clip">Googenix</span> Editors Behind the Superhit Ikko Mikke – <span className="underlined underline-clip2">250M+ Views</span> & Millions in Profit!
  ...
  },
  {
    ...
    media: {
      type: 'image', // ✅ Ensuring media is present
